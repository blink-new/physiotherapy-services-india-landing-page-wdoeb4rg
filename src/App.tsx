...
import { UserFlowGuide, FlowProgressIndicator } from './components/UserFlowGuide'
...
function App() {
  ...
  const [currentFlowStep, setCurrentFlowStep] = useState('browse')
  ...
  return (
    <SecurityProvider>
      <div className="min-h-screen bg-background">
        {/* User Flow Guide */}
        {showUserGuide && (
          <UserFlowGuide onComplete={() => setShowUserGuide(false)} />
        )}

        {/* Flow Progress Indicator */}
        <FlowProgressIndicator currentStep={currentFlowStep} />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="hidden md:flex items-center space-x-8">
                ...
                <LanguageSwitcher />
                <BookingDialog>
                  <Button className="book-consultation-btn bg-primary hover:bg-primary/90" onClick={() => setCurrentFlowStep('select')}>
            ...
            {isMenuOpen && (
              <div className="md:hidden py-4 border-t border-border">
                <div className="flex flex-col space-y-4">
                  ...
                  <a href="#contact" className="text-muted-foreground hover:text-primary transition-colors">{t('nav.contact')}</a>
                  <BookingDialog>
                    <Button className="book-consultation-btn bg-primary hover:bg-primary/90 w-full" onClick={() => setCurrentFlowStep('select')}>
                      {t('hero.bookConsultation')}
                    </Button>
                  </BookingDialog>
                </div>
              ...
              <div className="animate-fade-in-up">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                  <BookingDialog>
                    <Button 
                      size="lg" 
                      className="book-consultation-btn bg-primary hover:bg-primary/90 text-lg px-8 py-6"
                      onClick={() => setCurrentFlowStep('select')}
                    >
        ...
        {/* Services Section */}
        <section id="services" className="services-section py-16 bg-muted/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <CardContent>
                    ...
                    <BookingDialog serviceType={service.title}>
                      <Button 
                        variant="outline" 
                        className="w-full"
                        onClick={() => setCurrentFlowStep('book')}
                      >
                        {t('pricing.bookNow')}
                      </Button>
                    </BookingDialog>
                  ...
                  <CardContent>
                    ...
                    <BookingDialog planType={plan.name} amount={plan.amount}>
                      <Button 
                        ...
                        size="lg"
                        onClick={() => setCurrentFlowStep('pay')}
                      >
                        {t('pricing.bookNow')}
                      </Button>
                    </BookingDialog>
        ...
        <footer className="bg-foreground text-background py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="border-t border-muted/20 mt-8 pt-8 text-center text-muted">
              <p>&copy; 2024 PhysioCare India. All rights reserved. | Registered with Medical Council of India | SSL Secured & GDPR Compliant</p>
            </div>
          </div>
        </footer>
